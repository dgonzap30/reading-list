...
export function WeekCard({ week, state, setState, isCurrent, expanded, onToggle, onStartTimer, onToggleSession, onSaveNote, onSaveWriting }) {
  ...
  return (
    <motion.div
      layout
      className={clsx(
        'relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-5 shadow-sm transition-all',
        isCurrent ? 'ring-1 ring-emerald-400/40' : 'hover:border-white/20',
      )}
    >
      <div className="relative space-y-5">
        <button
          ...
          className="flex w-full items-center justify-between rounded-3xl border border-white/10 bg-white/5 px-4 py-3 text-left text-white transition hover:border-white/30 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-400 group"
        >
          <div>
          ...
          <Lucide.ChevronDown
            className={clsx(
              ...
              expanded ? 'rotate-180 text-emerald-200' : 'opacity-70 group-hover:opacity-100',
            )}
          />
        </button>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {(doneCount === week.sessions.length || fragmentCount > 0) && (
            <button
              ...
              className="inline-flex items-center gap-1 rounded-2xl bg-indigo-500/20 px-3 py-1 text-xs font-semibold text-indigo-50 hover:bg-indigo-500/30 transition"
            >
          ...
          >
            ...
            <div>
              ...
              <div
                ...
                className="mt-2 w-full min-h-[80px] rounded-3xl border border-white/10 bg-black/30 px-4 py-3 text-sm text-white cursor-text hover:border-white/20 transition group"
              >
              ...
              >
                <div className="space-y-4">
                  <textarea
                    ...
                    className="w-full h-[60vh] p-4 rounded-xl bg-black/30 border border-white/10 text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-emerald-500 resize-none text-base leading-relaxed"
                  />
