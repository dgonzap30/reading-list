  ...
  return (
    <div className="mx-auto mt-12 w-full max-w-6xl px-4 md:px-6">
      <div className="grid gap-4 md:grid-cols-2">
        <div className="relative overflow-hidden rounded-xl border border-white/20 bg-black p-5">
          <div className="flex items-center gap-2 text-white">
            <Lucide.Sparkles className="h-5 w-5 text-white/50" />
          ...
          <ul className="mt-4 space-y-3">
            {plan.sips.map((sip, index) => (
              <li key={`sip-${index}`} className="rounded-xl border border-white/20 bg-black p-3">
        ...
        <div className="relative overflow-hidden rounded-xl border border-white/20 bg-black p-5">
          <div className="flex items-center gap-2 text-white">
            <Lucide.Orbit className="h-5 w-5 text-white/50" />
          ...
          <ul className="mt-4 space-y-3">
            {plan.swaps.map((swap, index) => (
              <li key={`swap-${index}`} className="rounded-xl border border-white/20 bg-black p-3">
