        ...
        >
            <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div
                        ...
                        className="mt-3 w-full min-h-[64px] px-3 py-2 rounded-xl bg-black/30 border border-white/10 text-white/90 cursor-text hover:border-white/20 transition group"
                    >
                        {writing ? (
            ...
            <div className="flex flex-wrap gap-2 text-xs opacity-0 group-hover:opacity-100 transition-opacity">
                <button
                    ...
                    className="inline-flex items-center gap-1 rounded-lg border border-white/10 px-3 py-1 text-white/70 hover:border-white/30 hover:text-white/90 transition"
                >
